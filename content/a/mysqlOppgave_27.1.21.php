...
<div class="imagegrid">
    ...
    <div class="overskrift">
        <h1 class="navn1">MySQL <br>Oppgave 27.1.21 </h1> <!-- Overskriften -->
        </div>
</div>
</div>
</div>
        <div class="info1">
            ...
            <img src="../../assets/images/mySqlCode/1.JPG" alt="bildet" class="img"> <br>
            <p class="p1"> <a class="date1">Oppgave 1 <br></a> Placehold <br>Placehold <br>Placehold <br>Placehold</p>
            <br> <img src="../../assets/images/mySqlCode/2.JPG" alt="bildet" class="img"> <br>
            <p class="p1"> <a class="date1">Oppgave 2 <br></a> Placehold <br>Placehold <br>Placehold <br>Placehold</p>
            <br> <img src="../../assets/images/mySqlCode/3.JPG" alt="bildet" class="img"> <br>
            <p class="p1"> <a class="date1">Oppgave 3 <br></a> Placehold <br>Placehold <br>Placehold <br>Placehold</p>
        </div>
