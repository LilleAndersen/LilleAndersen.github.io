...
<meta property="og:title" content="Teknologiforståelse VG1">

<meta property="og:image" content="/icon.png">

<meta property="og:site_name" content="Tobias' Skoleside">

<meta property="og:link" content="https://lilleandersen.github.io/HTML/teknologiforst%C3%A5else_vg1">
...
<div class="imagegrid">
    ...
    <div class="overskrift">
        <h1 class="navn1">Teknologiforståelse <br> Amalie Skram VGS</h1> <!-- Overskriften -->
        </div>
</div>
</div>
</div>
        <div class="info1">
            ...
            <iframe src="https://docs.google.com/presentation/d/e/2PACX-1vSVBPmayuh8Jg4UN76QWuKHyMuGzc1zB-iG4PWtKEmkeomRIvsD8ArEa-qUwBeiPb8FJtJBvaJc7_54/embed?start=false&loop=true&delayms=5000" frameborder="0" class="img2" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe> <br>
            <p class="p1"> <a class="date1">04.11.20 <br></a> placeholder <br> placeholder <br> placeholder <br> placeholder</p> <br>
            <img src="../assets/images/game-2294201_1920.jpg" alt="bildet av en xbox kontroller" class="img"> <br>
            <p class="p1"> <a class="date1">04.11.20 <br></a> Dette bildet tilhører et tverrfaglig prosjekt. Prosjektet gikk på å lage en charity <br>
                stream for å samle inn penger til BCFS som en del av skolen sitt årlige <br>
                innsamlingsaksjon. Klassen vår måtte planlegge alt og vi hadde ansvar. <br>
                Jeg synes det var veldig gøy og streamen var en stor suksess. Mer info <a href="https://docs.google.com/document/d/1foxj9DL2PIXq5AzErvu6ryT_5wtbNj7TR9es8mGa4bM/edit?usp=sharing" target="_blank" class="her">her </a></p>
        </div>
